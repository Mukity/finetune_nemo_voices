    ...
    **kwargs: dict
    ...
    with open_dict(sc):
        ...
        if not specgen:
            ...
            sc.model.validation_ds.dataset._target_ = "nemo.tts.collections.torch.data.VocoderDataset"
            sc.model.train_ds.dataset._target_ = "nemo.tts.collections.torch.data.VocoderDataset"
